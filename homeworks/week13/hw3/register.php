    ...
    <div class="row">
      <div class="col-10 mx-auto">
        <h1 class="text-center display-4 title">MaoMao Chat Room</h2>
          <p class="text-center lead title">會員註冊</p>

          <form class="col-10 mx-auto" action="./handle_register.php" method="POST">

            <div class="form-group row">
            <label for="nickname"" class="col-2 col-form-label label-modify">暱稱</label>
              <div class="col-10">
                <input class="form-control" id="nickname" name="nickname" type="text" placeholder="請輸入暱稱">
              </div>
              ...
              <button class="btn btn-dark btn-md btn-modify" type="submit">註冊</button>
            </div>
